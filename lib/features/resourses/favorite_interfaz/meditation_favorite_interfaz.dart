...
class widget_meditacion_favorite extends StatefulWidget {
  const widget_meditacion_favorite({super.key});

  @override
  State<widget_meditacion_favorite> createState() => _widget_meditacion_favoriteState();
}

class _widget_meditacion_favoriteState extends State<widget_meditacion_favorite> {
  ...
  Future<void> _loadAudios() async {
    try {
      ...
      setState(() {
        audios = audiosFromDB
            .where((audio) => audio.favorite_meditation == true)
            .toList();
      });
    } catch (e) {
                  ...
                  ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        setState(() {
                          if (!updatedAudio.favorite_meditation) {
                            // ❌ ya no es favorito → lo quitamos de la lista
